        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LocationPointId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockProduct_LocationPoints_LocationPointId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockProduct_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualSellingPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceProducts_StockProduct_StockProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceProducts_StockProductId",
                table: "InvoiceProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockProduct_LocationPointId",
                table: "StockProduct",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockProduct_PurchaseId",
                table: "StockProduct",
                column: "PurchaseId");
